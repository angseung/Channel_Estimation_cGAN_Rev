...
plt.ylim([-16, -4])
plt.title("DCGAN Estimation Performance with 4641 Data Samples", fontsize="x-large")
...
plt.ylabel("NMSE (dB)", fontsize="large")
plt.ylim([-16, -4])
plt.title("DCGAN Estimation Performance with Test Data Samples", fontsize="x-large")
