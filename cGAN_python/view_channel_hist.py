...
plt.plot(dist_12, stats.norm.pdf(dist_12, r_12_real_mean, r_12_real_std), "--", label="25 PATH")
plt.plot(dist_25, stats.norm.pdf(dist_25, r_25_real_mean, r_comb_real_std), "--", label="25 PATH")
plt.plot(dist_comb, stats.norm.pdf(dist_comb, r_comb_real_mean, r_comb_real_std), label="comb")
plt.legend(loc='best')
plt.show()
