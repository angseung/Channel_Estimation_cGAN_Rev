...
fnames = [
    "../Data_Generation_matlab/Gan_Data/Gan_10_dB_25_path_Indoor2p5_64ant_32users_8pilot_val.mat",
...
for i, (paths, fname) in enumerate(zip([25, 12, 3], fnames)):
    ...
    for j, snr in enumerate(test_snr_list):
        ...
        ## Load test data
        TestData = (
            "../Data_Generation_matlab/Gan_Val_Data/Gan_%d_dB_%d_path_Indoor2p5_64ant_32users_8pilot_val2.mat"
            % (snr, paths)
        )
