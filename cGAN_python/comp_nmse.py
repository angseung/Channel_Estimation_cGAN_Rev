...
fig = plt.figure()
plt.plot(ep, nmse_ori, "^-", label="Original cGAN")
plt.plot(ep, nmse_bat1, ">-",  label="proposed GAN, BATCHSIZE=2")
plt.plot(ep, nmse_bat2, "<-",  label="proposed GAN, BATCHSIZE=4")
# plt.plot(ep, nmse_bat4, "^-",  label="proposed GAN, BATCHSIZE=4")
