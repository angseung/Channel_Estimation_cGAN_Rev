...
fig = plt.figure()
plt.plot(ep, nmse_ori, "b^-", label="Previous cGAN in [13]")
plt.plot(ep, nmse_bat1, "k>-",  label="cGAN with BatchNorm, BATCH SIZE=2")
plt.plot(ep, nmse_bat2, "r<-",  label="cGAN with BatchNorm, BATCH SIZE=4")
plt.plot(ep, nmse_bat4, "yv-",  label="cGAN with BatchNorm, BATCH SIZE=10")
